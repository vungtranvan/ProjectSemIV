...
public class Question01 implements Serializable {
    private int _id;
    ...
    public Question01(int _id, String question, String ans_a, String ans_b, String ans_c, String ans_d, String result, int num_exam, String subject, String image, String traloi) {
        this._id = _id;
